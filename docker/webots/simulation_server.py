...
class Client:
    ...
    def setup_project_from_zip(self):
        print('setup from zip')
        
        self.user1Id = 1
        self.user1Name = 'Dima'
        self.user1Authentication = '8d969eef6ecad3c29a3a629280e686cf0c3f5d5a86aff3ca12020c923adc6c92'
        self.key = ''
        ...
        if self.user1Id:
            ...
            with session() as c:
                print(self.host + '/ajax/download-project.php')
