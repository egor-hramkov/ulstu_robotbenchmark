...
class ProblemAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'world_path', 'image_path', 'difficulty', 'author')  # Список полей, которые будут отображаться в списке объектов
    list_display_links = ('id', 'title', 'world_path', 'image_path', 'difficulty')  # Список полей, которые будут отображаться в списке объектов
